var ng_ePayTrack_App = angular.module('ng_ePayTrack_App', [])
...
ng_ePayTrack_App.run(function () {
    ...
    String.prototype.get_page = function (table) {
        ...
        $('#' + table + ' tr').each(function () {
            $.each(this.cells, function (cells) {
                if (cells == 0) { $.each(this.cells, function (cells) {
                if (cells == 0) {
                    if ($(this).text() == this) {
                        nakit_an = true;
                        return false;
    ...
    String.prototype.highliteRow = function (table,id) {
        var id = this
        console.log($("#" + table))
        for (var x = 1; x <= $("#" + table).DataTable().page.info().pages; x++) {
            if (id.get_page(table) == false) {
...
ng_ePayTrack_App.service("commonScript", ["$compile", "$filter", function (c, f) {
...
ng_ePayTrack_App.directive('limitMaxMinVal', ["commonScript", function (cs) {
...
ng_ePayTrack_App.directive('mustMinVal', ["commonScript", function (cs) {
...
ng_ePayTrack_App.directive('mustMaxVal', ["commonScript", function (cs) {
...
ng_ePayTrack_App.directive('checkdata', ["commonScript", function (cs) {
...
ng_ePayTrack_App.directive('removeReq', ["commonScript", function (cs) {
    //************************************// 
...
ng_ePayTrack_App.directive('removeReqDate', ["commonScript", function (cs) {
    //************************************// 
    //*** this directive remove the required warning of the specified input field on keyup
    //************************************// 
    return {
...
ng_ePayTrack_App.directive('validateDate', ["commonScript", function (cs) {
    //************************************// 
    //*** this directive remove the required warning of the specified input field on keyup
    //************************************// 
    return {
...
ng_ePayTrack_App.directive('removeReqOption', ["commonScript", function (cs) {
    //************************************// 
...
ng_ePayTrack_App.directive('checkString', ["commonScript", function (cs) {
...
ng_ePayTrack_App.directive("headerSearch", ["commonScript", function (cs) {
    return {
        restrict: 'C',
        link: function (scope, elem, attrs) {
            elem.on('keyup', function () {
...
ng_ePayTrack_App.directive("setTableRow", ["commonScript", function (cs) {
    return {
        restrict: 'C',
        link: function (scope, elem, attrs) {
            elem.on('change', function () {
...
ng_ePayTrack_App.filter("filterdate", function () {
    var rx = /\/Date\(([0-9]*)\)\//;
    return function (x) {
        var m = x.match(rx);
        if (m) return new Date(parseInt(m[1]));
...
ng_ePayTrack_App.filter("bool-option", function () {
    return function (d) {
        if (d == true) {
            return "1";
        } else if (d == false) {
...
ng_ePayTrack_App.directive('timeMinVal', ["commonScript", function (cs) {
...
ng_ePayTrack_App.directive('timeMaxVal', ["commonScript", function (cs) {
...
ng_ePayTrack_App.directive('norequired', ["commonScript", function (cs) {
    var t = "type"
    var hA = "hasAttribute"
    //************************************// 
...
ng_ePayTrack_App.directive('reqfocus', ["commonScript", function (cs) {
...
ng_ePayTrack_App.directive('verifyItControlNbr', ["commonScript", function (cs, $http) {
    return {
        restrict: 'C',
        link: function (scope, elem, attrs) {
...
ng_ePayTrack_App.directive('scanItcdDoc', ["commonScript", "$http", function (cs, $http) {
    return {
        restrict: 'C',
...
ng_ePayTrack_App.directive('saveDoc', ["commonScript", "$http", function (cs, $http) {
