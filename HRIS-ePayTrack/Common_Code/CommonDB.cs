...
namespace HRIS_Common
{
	...
	class CommonDB
	{
		...
		public SqlConnection ConnectDB()
		{
			try
			{
				string ConnectString = ConfigurationManager.ConnectionStrings[connectstring_ePAccount].ConnectionString;
				SqlConnection conn;
		...
		public DataTable RetrieveData(string sp_script)
		{
			...
			{
				DataTable dt = new DataTable();
				string connStr = System.Configuration.ConfigurationManager.ConnectionStrings[connectstring_ePAccount].ConnectionString;
